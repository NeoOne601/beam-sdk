...
| ML document OCR model | Not yet available | AI team deliverable; all pipeline infrastructure is ready to receive it |
...
See `docs/LOCAL_EXECUTION_GUIDE.md` for the complete step-by-step setup. The backend, Rust test suite, FFI integration tests, and web sample are all runnable today without a trained ML model.
