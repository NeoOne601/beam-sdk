/*
 * beam_ffi.h — Canonical C header for the Beam SDK Rust FFI boundary.
 *
...
typedef void* BeamSessionHandle;
/** Opaque pointer to a Rust QualityGate. */
typedef void* BeamGateHandle;
 ...
 *
 * @param handle         Valid, non-null BeamSessionHandle.
