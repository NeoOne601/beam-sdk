// platform/android/AjnaCameraAdapter.kt
// Camera2 adapter for Ajna SDK.
 ...
 */
class AjnaCameraAdapter(
    private val cameraManager: CameraManager,
    private val ajnaSdk:       AjnaSDK,
) {

    private var cameraDevice:    CameraDevice?       = null
    private var captureSession:  CameraCaptureSession? = null
    private var imageReader:     ImageReader?         = null
    private val cameraThread =   HandlerThread("AjnaCamera").apply { start() }
