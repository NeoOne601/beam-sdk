// samples/ios/BeamVerifySample/ScanView.swift
// Camera scanning view with quality gate status overlay.
//
// Architecture note:
//   Camera (Swift AVCaptureSession) → BeamCameraAdapter → Quality Gates (Rust via C FFI)
//   → CoreML inference (C++ bridge) → beam_session_push_result (Rust FFI)
...
struct ScanView: View {
    ...
    /// In production, this is driven by real AVCaptureSession frames and Beam SDK callbacks.
